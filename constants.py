...
mainTable = "mainTable"
database = f"{rootSource}/database.db"
...
bankDetailsText = "твоя заявка подтверждена, для оплаты используй данные ниже\n\n" \
                  "*БАНКОВСКИЕ РЕКВИЗИТЫ*\nНомер карты: *665968375846*\nПолучатель платежа: *Иванов Иван Иванович*\n\nПосле оплаты нажми на кнопку ниже"
